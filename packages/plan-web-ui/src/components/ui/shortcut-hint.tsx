...
export function ShortcutHint({ shortcut }: { shortcut: ShortcutTarget }) {
  ...
  return (
    <span className="hidden rounded-md border border-[var(--border-strong)] bg-[var(--surface-elevated)] px-2 py-0.5 text-[11px] font-bold tracking-wide text-[var(--text-muted)] sm:inline-block">
