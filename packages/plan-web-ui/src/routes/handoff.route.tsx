    ...
    return (
      <Card className="grid gap-4">
        <div>
          ...
          <p className="text-xs text-[var(--text-muted)]">Handoff preflight supplies the required title and reason before drafting; timestamps and metadata are generated by the planner.</p>
        </div>
