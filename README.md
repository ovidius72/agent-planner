...
The current Phase 1 count is **35** public `planner-*` tools.
...
For automated MCP smoke testing, use the MCP SDK client to call `listTools`; the expected Phase 1 count is currently 35 public `planner-*` tools.
