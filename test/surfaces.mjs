...
export const coreSurfaces = [
  ...
  { id: "core.ideaDiscussionSkill", kind: "method", name: "PlanStore.ideaDiscussionSkill", description: "Load the managed project-local grill-me instructions only for an Ideas discussion or promotion workflow.", anchor: "packages/plan-core/src/plan-store.ts:1299", coverage: { phase: "P060", reason: "The cross-harness verification suite covers managed project skill lifecycle; Ideas promotion callers land in P091/T358." } },
  ...
  { id: "core.acceptedDecisionCreate", kind: "method", name: "PlanStore.createAcceptedDecision", description: "Create one project, feature, phase, or task Accepted Decision with planner-managed identity and acceptedAt.", anchor: "packages/plan-core/src/plan-store.ts:createAcceptedDecision", coverage: { phase: "P059", reason: "covered by cross-harness semantic Accepted Decisions regressions" } },
  { id: "core.acceptedDecisionUpdate", kind: "method", name: "PlanStore.updateAcceptedDecision", description: "Update mutable fields of one Accepted Decision while preserving identity and acceptedAt.", anchor: "packages/plan-core/src/plan-store.ts:updateAcceptedDecision", coverage: { phase: "P059", reason: "covered by cross-harness semantic Accepted Decisions regressions" } },
  { id: "core.acceptedDecisionDelete", kind: "method", name: "PlanStore.deleteAcceptedDecision", description: "Delete one explicitly identified Accepted Decision without replacing the owning array.", anchor: "packages/plan-core/src/plan-store.ts:deleteAcceptedDecision", coverage: { phase: "P059", reason: "covered by cross-harness semantic Accepted Decisions regressions" } },
  ...
  { id: "core.runBatch", kind: "method", name: "PlanStore.runBatch", description: "Run a root-scoped cross-process write transaction with nested-write re-entrancy.", anchor: "packages/plan-core/src/plan-store.ts", coverage: { phase: "P053", reason: "covered by core domain validation and root-writer coordination scenarios" } },
  { id: "core.writeCoordination", kind: "module", name: "withPlanRootWriteLock / PlanWriterBusyError", description: "Serialize planner-root mutations across processes while leaving reads available and returning typed contention diagnostics.", anchor: "packages/plan-core/src/write-coordination.ts", coverage: { phase: "P060", reason: "covered by cross-process core and real-server integration scenarios" } },
  ...
  // ── Ideas Inbox ──────────────────────────────────────────────────
  { id: "core.loadIdeas", kind: "method", name: "PlanStore.loadIdeas", description: "Load rollup-independent Ideas Inbox entries.", anchor: "packages/plan-core/src/plan-store.ts", coverage: { phase: "P060", reason: "covered by cross-harness Ideas lifecycle scenarios." } },
  { id: "core.createIdea", kind: "method", name: "PlanStore.createIdea", description: "Create an Idea with monotonic I-number and short ID.", anchor: "packages/plan-core/src/plan-store.ts", coverage: { phase: "P060", reason: "covered by cross-harness Ideas lifecycle scenarios." } },
  { id: "core.updateIdea", kind: "method", name: "PlanStore.updateIdea", description: "Update Idea-owned content atomically.", anchor: "packages/plan-core/src/plan-store.ts", coverage: { phase: "P060", reason: "covered by cross-harness Ideas lifecycle scenarios." } },
  { id: "core.deleteIdea", kind: "method", name: "PlanStore.deleteIdea", description: "Delete an Idea without affecting work rollups.", anchor: "packages/plan-core/src/plan-store.ts", coverage: { phase: "P060", reason: "covered by cross-harness Ideas lifecycle scenarios." } },
  { id: "core.promoteIdea", kind: "method", name: "PlanStore.promoteIdea", description: "Record validated feature/phase/task promotion history.", anchor: "packages/plan-core/src/plan-store.ts", coverage: { phase: "P060", reason: "covered by cross-harness Ideas lifecycle scenarios." } },
  ...
  { id: "core.listArchivedHandoffs", kind: "method", name: "PlanStore.listArchivedHandoffs", description: "Archived handoffs for canonical terminal phase outcomes, replacement, or manual clear.", anchor: "packages/plan-core/src/plan-store.ts:2044" },
  { id: "core.cleanupStaleHandoffs", kind: "method", name: "PlanStore.cleanupStaleHandoffs", description: "Auto-archive handoffs for every canonical terminal phase outcome.", anchor: "packages/plan-core/src/plan-store.ts:2008" },
  { id: "core.preparePhaseHandoff", kind: "method", name: "PlanStore.preparePhaseHandoff", description: "Return the exact pre-draft scaffold, source-review and cold-start inventory contract, current token, and missing durable task evidence.", anchor: "packages/plan-core/src/plan-store.ts:preparePhaseHandoff", coverage: { phase: "P060", reason: "covered by handoff context and cross-harness regression scenarios" } },
  { id: "core.refreshPhaseHandoff", kind: "method", name: "PlanStore.refreshPhaseHandoff", description: "Atomically persist a scaffold-complete handoff only after concrete cold-start inventory coverage and durable context verification.", anchor: "packages/plan-core/src/plan-store.ts:refreshPhaseHandoff", coverage: { phase: "P060", reason: "covered by handoff context and cross-harness regression scenarios" } },
  ...
  { id: "core.buildPhaseContextBlock", kind: "function", name: "buildPhaseContextBlock", description: "Task-start context including project/feature/phase/task Accepted Decisions and linked Requirements.", anchor: "packages/plan-core/src/task-context.ts:buildPhaseContextBlock", coverage: { phase: "P059", reason: "covered by cross-harness task-start canonical context regressions." } },
  { id: "core.boundedAcceptedDecisionContext", kind: "function", name: "buildBoundedAcceptedDecisionContext", description: "Bound ambient/load Accepted Decision context while preserving explicit truncation guidance.", anchor: "packages/plan-core/src/task-context.ts:buildBoundedAcceptedDecisionContext", coverage: { phase: "P059", reason: "covered by core bounded-context and MCP/Pi load-context regressions." } },
  { id: "core.markCanonicalFullRead", kind: "function", name: "markCanonicalFullReadForSessionId", description: "Refuse feature/phase/task read attestation when any canonical Accepted Decision field is omitted.", anchor: "packages/plan-core/src/read-tracking.ts:markCanonicalFullReadForSessionId", coverage: { phase: "P059", reason: "covered by core omission rejection and cross-harness full-read regressions." } },
  ...
  { id: "core.runtimeDiagnostics", kind: "module", name: "runtime-diagnostics.ts", description: "Expose loaded-runtime provenance helpers, plan schema version, allocation registry version, supported allocation kinds, and typed compatibility upgrade diagnostics.", anchor: "packages/plan-core/src/runtime-diagnostics.ts", coverage: { phase: "P059", reason: "covered by runtime diagnostics and false-success mutation response regressions." } },
  { id: "core.requirementReadEligibility", kind: "function", name: "requirementReadEligibilityForSession", description: "Report exact missing/stale target-linked Requirement reads while reusing only fresh delivered session evidence.", anchor: "packages/plan-core/src/read-tracking.ts:requirementReadEligibilityForSession", coverage: { phase: "P059", reason: "covered by core and cross-harness target-scoped Requirement read regressions." } },
...
export const apiSurfaces = [
  ...
  { id: "api.acceptedDecisionCreate", kind: "route", name: "POST /api/accepted-decisions", description: "Create one Accepted Decision for a project, feature, phase, or task owner.", anchor: "packages/plan-server/src/serve.ts:/accepted-decisions", coverage: { phase: "P059", reason: "covered by cross-harness semantic Accepted Decisions regressions" } },
  { id: "api.acceptedDecisionUpdate", kind: "route", name: "PUT /api/accepted-decisions/:decisionId", description: "Update one Accepted Decision and preserve planner-owned metadata.", anchor: "packages/plan-server/src/serve.ts:/accepted-decisions/:decisionId", coverage: { phase: "P059", reason: "covered by cross-harness semantic Accepted Decisions regressions" } },
  { id: "api.acceptedDecisionDelete", kind: "route", name: "DELETE /api/accepted-decisions/:decisionId", description: "Delete one Accepted Decision after explicit confirmation.", anchor: "packages/plan-server/src/serve.ts:/accepted-decisions/:decisionId", coverage: { phase: "P059", reason: "covered by cross-harness semantic Accepted Decisions regressions" } },
  ...
  { id: "api.getIdeas", kind: "route", name: "GET /api/ideas", description: "List independent Ideas Inbox entries.", anchor: "packages/plan-server/src/serve.ts", coverage: { phase: "P054", reason: "covered by real HTTP Ideas CRUD scenarios." } },
  { id: "api.createIdea", kind: "route", name: "POST /api/ideas", description: "Create an Idea with server-owned identity.", anchor: "packages/plan-server/src/serve.ts", coverage: { phase: "P054", reason: "covered by real HTTP Ideas CRUD scenarios." } },
  { id: "api.updateIdea", kind: "route", name: "PUT /api/ideas/:id", description: "Update Idea-owned title and description.", anchor: "packages/plan-server/src/serve.ts", coverage: { phase: "P054", reason: "covered by real HTTP Ideas CRUD scenarios." } },
  { id: "api.deleteIdea", kind: "route", name: "DELETE /api/ideas/:id", description: "Delete an Idea without affecting work rollups.", anchor: "packages/plan-server/src/serve.ts", coverage: { phase: "P054", reason: "covered by real HTTP Ideas CRUD scenarios." } },
  ...
  { id: "api.updateFeature", kind: "route", name: "PUT /api/features/:id", description: "Update canonical feature fields; rejects derived-status changes and raw Accepted Decisions replacement.", anchor: "packages/plan-server/src/serve.ts:318", coverage: { phase: "P059", reason: "covered by cross-harness mutation parity regressions" } },
  ...
  { id: "api.updatePhase", kind: "route", name: "PUT /api/phases/:id", description: "Update canonical phase planning fields and parent relinking; rejects derived-status changes and raw Accepted Decisions replacement.", anchor: "packages/plan-server/src/serve.ts:462", coverage: { phase: "P059", reason: "covered by cross-harness mutation parity regressions" } },
  ...
  { id: "api.updateTask", kind: "route", name: "PUT /api/tasks/:id", description: "Update canonical task context fields with lifecycle/motivation gates; rejects raw Accepted Decisions replacement.", anchor: "packages/plan-server/src/serve.ts:617", coverage: { phase: "P059", reason: "covered by cross-harness mutation parity regressions" } },
...
export const mcpSurfaces = [
  ...
  { id: "mcp.projectGuidelinesShow", kind: "tool", name: "planner-project-guidelines-show", description: "Read canonical Project Guidelines.", anchor: "packages/plan-mcp/src/index.ts:467", coverage: { phase: "P055", reason: "covered by MCP adapter integration scenarios in the published tool suite." } },
  { id: "mcp.projectGuidelinesUpdate", kind: "tool", name: "planner-project-guidelines-update", description: "Replace canonical Project Guidelines.", anchor: "packages/plan-mcp/src/index.ts:486", coverage: { phase: "P055", reason: "covered by MCP adapter integration scenarios in the published tool suite." } },
  { id: "mcp.projectContextMigrate", kind: "tool", name: "planner-project-context-migrate", description: "Preview or apply explicit legacy project-context migration.", anchor: "packages/plan-mcp/src/index.ts:544", coverage: { phase: "P055", reason: "covered by MCP adapter integration scenarios in the published tool suite." } },
  { id: "mcp.acceptedDecisionCreate", kind: "tool", name: "planner-accepted-decision-create", description: "Create one Accepted Decision on any canonical owner.", anchor: "packages/plan-mcp/src/index.ts:planner-accepted-decision-create", coverage: { phase: "P059", reason: "covered by MCP semantic Accepted Decisions CRUD regressions" } },
  { id: "mcp.acceptedDecisionUpdate", kind: "tool", name: "planner-accepted-decision-update", description: "Update one Accepted Decision while preserving planner-owned metadata.", anchor: "packages/plan-mcp/src/index.ts:planner-accepted-decision-update", coverage: { phase: "P059", reason: "covered by MCP semantic Accepted Decisions CRUD regressions" } },
  { id: "mcp.acceptedDecisionDelete", kind: "tool", name: "planner-accepted-decision-delete", description: "Delete one Accepted Decision after explicit confirmation.", anchor: "packages/plan-mcp/src/index.ts:planner-accepted-decision-delete", coverage: { phase: "P059", reason: "covered by MCP semantic Accepted Decisions CRUD regressions" } },
  { id: "mcp.requirementList", kind: "tool", name: "planner-requirement-list", description: "List requirements without attestation, or deliver and attest only target-relevant requirements when phaseRef is supplied.", anchor: "packages/plan-mcp/src/index.ts:planner-requirement-list", coverage: { phase: "P059", reason: "covered by cross-harness target-scoped requirement-read regressions." } },
  { id: "mcp.requirementCreate", kind: "tool", name: "planner-requirement-create", description: "Create requirements with planner-managed macro-task metadata.", anchor: "packages/plan-mcp/src/index.ts:2056", coverage: { phase: "P055", reason: "covered by MCP requirement parity integration scenarios." } },
  { id: "mcp.requirementUpdate", kind: "tool", name: "planner-requirement-update", description: "Update requirement-owned values and ordered macro tasks.", anchor: "packages/plan-mcp/src/index.ts:2097", coverage: { phase: "P055", reason: "covered by MCP requirement parity integration scenarios." } },
  { id: "mcp.requirementDelete", kind: "tool", name: "planner-requirement-delete", description: "Delete a requirement after confirmation.", anchor: "packages/plan-mcp/src/index.ts:2155", coverage: { phase: "P055", reason: "covered by MCP requirement parity integration scenarios." } },
  { id: "mcp.ideaList", kind: "tool", name: "planner-idea-list", description: "List Ideas Inbox entries.", anchor: "packages/plan-mcp/src/index.ts", coverage: { phase: "P055", reason: "covered by real MCP Ideas transport scenarios." } },
  { id: "mcp.ideaShow", kind: "tool", name: "planner-idea-show", description: "Show one Idea.", anchor: "packages/plan-mcp/src/index.ts", coverage: { phase: "P055", reason: "covered by real MCP Ideas transport scenarios." } },
  { id: "mcp.ideaCreate", kind: "tool", name: "planner-idea-create", description: "Create an Idea.", anchor: "packages/plan-mcp/src/index.ts", coverage: { phase: "P055", reason: "covered by real MCP Ideas transport scenarios." } },
  { id: "mcp.ideaUpdate", kind: "tool", name: "planner-idea-update", description: "Update an Idea.", anchor: "packages/plan-mcp/src/index.ts", coverage: { phase: "P055", reason: "covered by real MCP Ideas transport scenarios." } },
  { id: "mcp.ideaDelete", kind: "tool", name: "planner-idea-delete", description: "Delete a confirmed Idea.", anchor: "packages/plan-mcp/src/index.ts", coverage: { phase: "P055", reason: "covered by real MCP Ideas transport scenarios." } },
  { id: "mcp.ideaPromotionBegin", kind: "tool", name: "planner-idea-promotion-begin", description: "Load grill-me and propose a promotion without writes.", anchor: "packages/plan-mcp/src/index.ts", coverage: { phase: "P055", reason: "covered by real MCP Ideas transport scenarios." } },
  { id: "mcp.ideaPromotionFinalize", kind: "tool", name: "planner-idea-promotion-finalize", description: "Record a confirmed promotion to a validated target.", anchor: "packages/plan-mcp/src/index.ts", coverage: { phase: "P055", reason: "covered by real MCP Ideas transport scenarios." } },
  ...
  { id: "mcp.featureShow", kind: "tool", name: "planner-feature-show", description: "Feature detail with canonical Accepted Decisions before full-read attestation.", anchor: "packages/plan-mcp/src/index.ts:planner-feature-show", coverage: { phase: "P059", reason: "covered by MCP Accepted Decision full-read regressions." } },
  ...
  { id: "mcp.featureUpdate", kind: "tool", name: "planner-feature-update", description: "Update canonical feature context fields while keeping derived status read-only.", anchor: "packages/plan-mcp/src/index.ts:490", coverage: { phase: "P059", reason: "covered by cross-harness mutation parity regressions" } },
  ...
  { id: "mcp.phaseShow", kind: "tool", name: "planner-phase-show", description: "Phase detail with canonical Accepted Decisions and linked Requirements before full-read attestation.", anchor: "packages/plan-mcp/src/index.ts:planner-phase-show", coverage: { phase: "P059", reason: "covered by MCP Accepted Decision full-read regressions." } },
  { id: "mcp.phaseDiscuss", kind: "tool", name: "planner-phase-discuss", description: "Persist phase discovery and readiness without overriding derived status.", anchor: "packages/plan-mcp/src/index.ts:647", coverage: { phase: "P059", reason: "covered by cross-harness mutation parity regressions" } },
  { id: "mcp.phaseUpdate", kind: "tool", name: "planner-phase-update", description: "Update canonical phase planning fields and parent relinking.", anchor: "packages/plan-mcp/src/index.ts:682", coverage: { phase: "P059", reason: "covered by cross-harness mutation parity regressions" } },
  ...
  { id: "mcp.taskShow", kind: "tool", name: "planner-task-show", description: "Task detail with canonical Accepted Decisions, resume context, and statusLog before full-read attestation.", anchor: "packages/plan-mcp/src/index.ts:planner-task-show", coverage: { phase: "P059", reason: "covered by MCP Accepted Decision full-read regressions." } },
  ...
  { id: "mcp.taskUpdate", kind: "tool", name: "planner-task-update", description: "Update canonical task context, decisions, and checklist fields with lifecycle motivation gates.", anchor: "packages/plan-mcp/src/index.ts:829", coverage: { phase: "P059", reason: "covered by cross-harness mutation parity regressions" } },
  ...
  { id: "mcp.handoffShow", kind: "tool", name: "planner-handoff-show", description: "Read the active phase handoff or latest terminal archive with discoverable closeout document references.", anchor: "packages/plan-mcp/src/index.ts:planner-handoff-show", coverage: { phase: "P059", reason: "covered by MCP terminal handoff archive regressions" } },
  { id: "mcp.handoffWrite", kind: "tool", name: "planner-handoff-write", description: "Persist one scaffold-complete handoff candidate with resumeReady=false pending a separate read-back.", anchor: "packages/plan-mcp/src/index.ts:planner-handoff-write" },
  { id: "mcp.handoffVerify", kind: "tool", name: "planner-handoff-verify", description: "Finalize a shown persisted handoff only after fresh source reconciliation finds no omissions.", anchor: "packages/plan-mcp/src/index.ts:planner-handoff-verify" },
  { id: "mcp.handoffPrepare", kind: "tool", name: "planner-handoff-prepare", description: "Return the exact pre-draft scaffold, source-review checklist, inventory categories, optimistic token, and inline budget.", anchor: "packages/plan-mcp/src/index.ts:1139" },
  ...
  { id: "mcp.load", kind: "tool", name: "planner-load", description: "Start web + recap with bounded project/feature/phase/task Accepted Decision agentContext.", anchor: "packages/plan-mcp/src/index.ts:planner-load", coverage: { phase: "P059", reason: "covered by MCP planner-load Accepted Decision context regressions." } },
...
export const piSurfaces = [
  { id: "pi.command", kind: "command", name: "/planner <subcommand>", description: "Hierarchical command: init/show/version/repair/cleanup-orphans/project <discuss|language|guidelines>/idea <list|add|show|update|delete|promote>/feature <add|show|discuss|update|delete|list>/phase <add|show|discuss|update|delete|list>/task <add|show|discuss|update|delete|list|start|complete|checklist <toggle|add|remove>>/handoff <list|show|write|clear|prepare>/bypass/clear-bypass/load/stop|disable/web <status>.", anchor: "packages/pi-adapter/src/index.ts:2424", coverage: { phase: "P056", reason: "covered by Pi adapter scenarios (P056)" } },
  ...
  { id: "pi.tool.projectGuidelinesShow", kind: "tool", name: "project_guidelines_show", description: "Read canonical Project Guidelines.", anchor: "packages/pi-adapter/src/index.ts:2846", coverage: { phase: "P056", reason: "covered by Pi adapter integration scenarios in the registered tool suite." } },
  { id: "pi.tool.projectGuidelinesUpdate", kind: "tool", name: "project_guidelines_update", description: "Replace canonical Project Guidelines.", anchor: "packages/pi-adapter/src/index.ts:2873", coverage: { phase: "P056", reason: "covered by Pi adapter integration scenarios in the registered tool suite." } },
  { id: "pi.tool.projectContextMigrate", kind: "tool", name: "project_context_migrate", description: "Preview or apply explicit legacy project-context migration.", anchor: "packages/pi-adapter/src/index.ts:2994", coverage: { phase: "P056", reason: "covered by Pi adapter integration scenarios in the registered tool suite." } },
  { id: "pi.tool.acceptedDecisionCreate", kind: "tool", name: "accepted_decision_create", description: "Create one Accepted Decision on any canonical owner.", anchor: "packages/pi-adapter/src/index.ts:accepted_decision_create", coverage: { phase: "P059", reason: "covered by Pi semantic Accepted Decisions CRUD regressions" } },
  { id: "pi.tool.acceptedDecisionUpdate", kind: "tool", name: "accepted_decision_update", description: "Update one Accepted Decision while preserving planner-owned metadata.", anchor: "packages/pi-adapter/src/index.ts:accepted_decision_update", coverage: { phase: "P059", reason: "covered by Pi semantic Accepted Decisions CRUD regressions" } },
  { id: "pi.tool.acceptedDecisionDelete", kind: "tool", name: "accepted_decision_delete", description: "Delete one Accepted Decision after explicit confirmation.", anchor: "packages/pi-adapter/src/index.ts:accepted_decision_delete", coverage: { phase: "P059", reason: "covered by Pi semantic Accepted Decisions CRUD regressions" } },
  { id: "pi.tool.requirementList", kind: "tool", name: "requirement_list", description: "List requirements without attestation, or deliver and attest only target-relevant requirements when phaseRef is supplied.", anchor: "packages/pi-adapter/src/index.ts:requirement_list", coverage: { phase: "P059", reason: "covered by cross-harness target-scoped requirement-read regressions." } },
  ...
  { id: "pi.tool.handoffShow", kind: "tool", name: "handoff_show", description: "Read the active phase handoff or latest terminal archive with discoverable closeout document references.", anchor: "packages/pi-adapter/src/index.ts:handoff_show", coverage: { phase: "P059", reason: "covered by Pi terminal handoff archive regressions" } },
  { id: "pi.tool.handoffPrepare", kind: "tool", name: "handoff_prepare", description: "Return the exact pre-draft scaffold, source-review checklist, inventory categories, optimistic token, and inline budget.", anchor: "packages/pi-adapter/src/index.ts:handoff_prepare", coverage: { phase: "P060", reason: "covered by Pi adapter handoff mutation regressions" } },
  { id: "pi.tool.handoffWrite", kind: "tool", name: "handoff_write", description: "Persist one scaffold-complete handoff candidate with resumeReady=false pending a separate read-back.", anchor: "packages/pi-adapter/src/index.ts:handoff_write" },
  { id: "pi.tool.handoffVerify", kind: "tool", name: "handoff_verify", description: "Finalize a shown persisted handoff only after fresh source reconciliation finds no omissions.", anchor: "packages/pi-adapter/src/index.ts:handoff_verify" },
  ...
  { id: "pi.tool.ideaList", kind: "tool", name: "idea_list", description: "List Ideas Inbox entries.", anchor: "packages/pi-adapter/src/index.ts", coverage: { phase: "P056", reason: "covered by Pi adapter Ideas scenarios." } },
  { id: "pi.tool.ideaShow", kind: "tool", name: "idea_show", description: "Show one Idea.", anchor: "packages/pi-adapter/src/index.ts", coverage: { phase: "P056", reason: "covered by Pi adapter Ideas scenarios." } },
  { id: "pi.tool.ideaCreate", kind: "tool", name: "idea_create", description: "Create an Idea.", anchor: "packages/pi-adapter/src/index.ts", coverage: { phase: "P056", reason: "covered by Pi adapter Ideas scenarios." } },
  { id: "pi.tool.ideaUpdate", kind: "tool", name: "idea_update", description: "Update an Idea.", anchor: "packages/pi-adapter/src/index.ts", coverage: { phase: "P056", reason: "covered by Pi adapter Ideas scenarios." } },
  { id: "pi.tool.ideaDelete", kind: "tool", name: "idea_delete", description: "Delete a confirmed Idea.", anchor: "packages/pi-adapter/src/index.ts", coverage: { phase: "P056", reason: "covered by Pi adapter Ideas scenarios." } },
  { id: "pi.tool.ideaPromotionBegin", kind: "tool", name: "idea_promotion_begin", description: "Load grill-me and propose a promotion without writes.", anchor: "packages/pi-adapter/src/index.ts", coverage: { phase: "P056", reason: "covered by Pi adapter Ideas scenarios." } },
  { id: "pi.tool.ideaPromotionFinalize", kind: "tool", name: "idea_promotion_finalize", description: "Record a confirmed promotion to a validated target.", anchor: "packages/pi-adapter/src/index.ts", coverage: { phase: "P056", reason: "covered by Pi adapter Ideas scenarios." } },
  ...
  { id: "pi.tool.featureGet", kind: "tool", name: "feature_get", description: "Feature detail with canonical Accepted Decisions before full-read attestation.", anchor: "packages/pi-adapter/src/index.ts:feature_get", coverage: { phase: "P059", reason: "covered by Pi Accepted Decision full-read regressions." } },
  ...
  { id: "pi.tool.featureUpdate", kind: "tool", name: "feature_update", description: "Update canonical feature context fields; rejects raw Accepted Decisions replacement.", anchor: "packages/pi-adapter/src/index.ts:3118", coverage: { phase: "P059", reason: "covered by cross-harness mutation parity regressions" } },
  ...
  { id: "pi.tool.phaseGet", kind: "tool", name: "phase_get", description: "Phase detail with canonical Accepted Decisions and linked Requirements before full-read attestation.", anchor: "packages/pi-adapter/src/index.ts:phase_get", coverage: { phase: "P059", reason: "covered by Pi Accepted Decision full-read regressions." } },
  { id: "pi.tool.phaseCreate", kind: "tool", name: "phase_create", description: "Create phase.", anchor: "packages/pi-adapter/src/index.ts:3280" },
  { id: "pi.tool.phaseDiscuss", kind: "tool", name: "phase_discuss", description: "Persist phase discovery and readiness without overriding derived status.", anchor: "packages/pi-adapter/src/index.ts:phase_discuss", coverage: { phase: "P059", reason: "covered by cross-harness mutation parity regressions" } },
  { id: "pi.tool.phaseUpdate", kind: "tool", name: "phase_update", description: "Update canonical phase planning fields and parent relinking.", anchor: "packages/pi-adapter/src/index.ts:3345", coverage: { phase: "P059", reason: "covered by cross-harness mutation parity regressions" } },
  ...
  { id: "pi.tool.taskGet", kind: "tool", name: "task_get", description: "Task detail with canonical Accepted Decisions and resume context before full-read attestation.", anchor: "packages/pi-adapter/src/index.ts:task_get", coverage: { phase: "P059", reason: "covered by Pi Accepted Decision full-read regressions." } },
  { id: "pi.tool.taskCreate", kind: "tool", name: "task_create", description: "Create task.", anchor: "packages/pi-adapter/src/index.ts:3527" },
  { id: "pi.tool.taskUpdate", kind: "tool", name: "task_update", description: "Update canonical task context and decisions with lifecycle motivation gates; rejects raw Accepted Decisions replacement.", anchor: "packages/pi-adapter/src/index.ts:3599", coverage: { phase: "P059", reason: "covered by cross-harness mutation parity regressions" } },
...
export const uiSurfaces = [
  ...
  { id: "ui.loader.phaseDetail", kind: "loader", name: "phase-detail loader", description: "current feature + all relink targets + phase + linkedRequirements.", anchor: "packages/plan-web-ui/src/routes/phase-detail/loader.ts", coverage: { phase: "P059", reason: "covered by Web UI mutation parity regressions" } },
  ...
  { id: "ui.action.featureEdit", kind: "action", name: "feature-edit action", description: "PUT canonical feature context including descriptionRef without direct derived-status mutation.", anchor: "packages/plan-web-ui/src/routes/feature-edit.action.ts", coverage: { phase: "P059", reason: "covered by Web UI mutation parity regressions" } },
  ...
  { id: "ui.action.featureStatus", kind: "action", name: "feature-status action", description: "Legacy direct feature-status request; server rejects derived-status changes.", anchor: "packages/plan-web-ui/src/routes/feature-status.action.ts", coverage: { phase: "P057", reason: "covered by Web UI harness scenarios (P057)" } },
  ...
  { id: "ui.action.phaseEdit", kind: "action", name: "phase-edit action", description: "PUT canonical planning fields and parent relinking without direct derived-status mutation.", anchor: "packages/plan-web-ui/src/routes/phase-edit.action.ts", coverage: { phase: "P059", reason: "covered by Web UI mutation parity regressions" } },
  ...
  { id: "ui.action.phaseStatus", kind: "action", name: "phase-status action", description: "Legacy direct phase-status request; server rejects derived-status changes.", anchor: "packages/plan-web-ui/src/routes/phase-status.action.ts", coverage: { phase: "P057", reason: "covered by Web UI harness scenarios (P057)" } },
  ...
  { id: "ui.action.taskEdit", kind: "action", name: "task-edit action", description: "PUT task descriptionRef, notes, decisions, motivation, checklist, and editable execution fields.", anchor: "packages/plan-web-ui/src/routes/task-edit.action.ts", coverage: { phase: "P059", reason: "covered by Web UI mutation parity regressions" } },
  ...
  { id: "ui.action.acceptedDecision", kind: "action", name: "accepted-decision action", description: "Create, update, or confirmed-delete one Accepted Decision through semantic API routes.", anchor: "packages/plan-web-ui/src/routes/accepted-decision.action.ts", coverage: { phase: "P059", reason: "covered by Web UI Accepted Decisions management regressions" } },
  { id: "ui.component.acceptedDecisions", kind: "component", name: "AcceptedDecisionsList", description: "Display and manage project, feature, phase, and task Accepted Decisions.", anchor: "packages/plan-web-ui/src/components/ui/accepted-decisions-list.tsx", coverage: { phase: "P059", reason: "covered by Web UI Accepted Decisions management regressions" } },
