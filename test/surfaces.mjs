...
export const mcpSurfaces = [
  ...
  { id: "mcp.handoffWrite", kind: "tool", name: "planner-handoff-write", description: "Persist one scaffold-complete handoff with completeness audit, source reviews, and concrete cold-start inventory coverage.", anchor: "packages/plan-mcp/src/index.ts:1104" },
...
export const piSurfaces = [
  ...
  { id: "pi.tool.handoffWrite", kind: "tool", name: "handoff_write", description: "Persist one scaffold-complete handoff with completeness audit, source reviews, and concrete cold-start inventory coverage.", anchor: "packages/pi-adapter/src/index.ts:2894" },
